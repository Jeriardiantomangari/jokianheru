...
<div class="konten-utama">
  ...
  <table id="tabel-outlet" class="tabel-barang">
    ...
    <tbody>
      ...
      $query = mysqli_query($conn,"SELECT * FROM outlet ORDER BY id ASC");
      ...
      <tr>
        ...
        <td data-label="Aksi">
          <button class="tombol tombol-edit" onclick="editOutlet(<?= $row['id']; ?>)">
            <i class="fa-solid fa-pen-to-square"></i> Edit
          </button>
          <button class="tombol tombol-hapus" onclick="hapusOutlet(<?= $row['id']; ?>)">
