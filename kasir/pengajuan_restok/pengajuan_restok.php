...
<div id="modalAjukan" class="kotak-modal">
  <div class="isi-modal">
    ...
    <form id="formAjukan">
      ...
      <input type="number" id="harga" name="harga" placeholder="Harga satuan" readonly>
...
// KASIR: konfirmasi barang sudah sampai → status Selesai + stok_outlet naik
function selesaiRestok(id) {
  if (!confirm('Konfirmasi bahwa barang ini SUDAH sampai di outlet dan stok akan ditambah?')) return;
