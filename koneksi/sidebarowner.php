  ...
  <div class="menu-samping" id="menuSamping">
    ...
    <div class="daftar-menu">
     <a href="../konfirmasi_restok/konfirmasi_restok.php" class="<?= $halaman == 'konfirmasi_restok.php' ? 'active' : '' ?>">
       ...
       <a href="../laporan_penjualan/laporan_penjualan.php" class="<?= $halaman == 'laporan_penjualan.php' ? 'active' : '' ?>">
        <i class="fa-solid fa-clipboard-check"></i> Laporan Penjualan
      </a>
    
      <a href="../laporan_stok_barang/laporan_stok_barang.php" class="<?= $halaman == 'laporan_stok_barang.php' ? 'active' : '' ?>">
        <i class="fa-solid fa-clipboard-check"></i> Laporan Stok Barang
     </a>
